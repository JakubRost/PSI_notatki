...
#docs <- DirSource("Data.txt")
# W razie potrzeby dostosuj ścieżkę
docs <- DirSource("C:/Users/jr469435/Documents/R_PSI")


# Utwórz korpus dokumentów tekstowych

# Gdy tekst znajduje się w jednym pliku csv:
data <- read.csv("C:/Users/jr469435/Documents/R_PSI/LOT_reviews.csv", stringsAsFactors = FALSE, encoding = "UTF-8")
